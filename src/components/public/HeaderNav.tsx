      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 md:h-20 flex items-center justify-between gap-4">
        ...
        <a href="#" className="flex items-center gap-3 group">
          ...
          <div>
            ...
            <span className="text-[10px] md:text-xs text-[#877259] font-extrabold tracking-wider uppercase flex items-center gap-1">
        ...
        {/* Desktop Quick Nav */}
        <nav className="hidden md:flex items-center gap-6 text-sm font-bold text-[#4B5E7A]">
          <a href="#paket" className="hover:text-[#16253D] transition-colors">
            Paket Hemat
          </a>
          <a href="#menu" className="hover:text-[#16253D] transition-colors">
            Katalog Menu
          </a>
          <a href="#sauce" className="hover:text-[#16253D] transition-colors">
            Aneka Saus
          </a>
          <a href="#lokasi" className="hover:text-[#16253D] transition-colors">
            Lokasi Soreang
          </a>
        </nav>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full border border-[#CFC8B8] bg-white text-xs font-bold text-[#16253D] hover:bg-[#EFECE3] hover:border-[#16253D] transition-all shadow-2xs"
          >
          ...
          <button
            onClick={onOpenCart}
            id="cart-trigger-btn"
            className="flex items-center gap-2.5 px-4 py-2.5 md:py-3 bg-[#16253D] hover:bg-[#1D2D44] text-white rounded-full font-black text-xs md:text-sm active:scale-95 transition-all shadow-md glow-navy border border-[#2C3E5A]"
