  ...
  return (
    <footer id="lokasi" className="bg-[#0E1B2E] text-white border-t border-[#1D2D44] mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="flex items-center gap-3 pt-2">
              {store.instagramUrl && (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#1D2D44] hover:bg-[#EAA623] hover:text-[#16253D] flex items-center justify-center text-white transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-[#1D2D44] hover:bg-[#25D366] flex items-center justify-center text-white transition-colors"
                aria-label="WhatsApp"
              >
          ...
          <div className="space-y-3">
            ...
            {operational.closedDays && operational.closedDays.length > 0 && (
              <p className="text-xs text-[#D83A2E] font-bold">
          ...
          <div className="space-y-3">
            ...
            {store.mapsUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs font-bold text-[#EAA623] hover:underline pt-1"
              >
        ...
        {/* Subfooter */}
        <div className="mt-12 pt-6 border-t border-[#1D2D44] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#64748B]">
          <p>© 2026 {store.storeName} — Balikin Mood with Good Food ♡. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <Link
              href="/admin/login"
              className="hover:text-[#94A3B8] transition-colors flex items-center gap-1 opacity-70 hover:opacity-100"
            >
