...
export const INITIAL_PRODUCTS: ProductItem[] = [
  ...
  // =========================================================================
  {
    ...
    description: "Daging sapi pedas manis rempah pilihan. Siap goreng isi 10 pcs per pack.",
    price: 55000,
  ...
  },
  {
    ...
    description: "Daging paru pedas nampol aroma daun jeruk. Siap goreng isi 10 pcs per pack.",
    price: 40000,
    imageUrl: "/images/cireng-mentah.webp",
    isAvailable: true,
    sortOrder: 7,
  ...
  },
  {
    ...
    description: "Keju cheddar melimpah gurih lumer nikmat. Siap goreng isi 10 pcs per pack.",
    price: 40000,
    imageUrl: "/images/cireng-mentah.webp",
    isAvailable: true,
    sortOrder: 8,
  ...
  },
  {
    ...
    description: "Ayam suwir pedas gurih bumbu rempah spesial. Siap goreng isi 10 pcs per pack.",
    price: 40000,
    imageUrl: "/images/cireng-mentah.webp",
    isAvailable: true,
    sortOrder: 9,
  ...
  },
  {
    ...
    description: "Mix aneka varian rasa favorit pilihan keluarga. Siap goreng isi 10 pcs per pack.",
    price: 40000,
    imageUrl: "/images/cireng-mentah.webp",
    isAvailable: true,
    sortOrder: 10,
  ...
  },
  {
    ...
    description: "Potongan sosis dengan sauce bolognese khas resto. Siap goreng isi 10 pcs per pack.",
    price: 40000,
    imageUrl: "/images/cireng-mentah.webp",
    isAvailable: true,
    sortOrder: 11,
